...
* This process enables automatic correction of configuration drift. However, this may add complexity with some configuration items such as the power state of the VM.
